...
var RelayQueryFragment = (function (_RelayQueryNode3) {
  ...
  RelayQueryFragment.prototype.getConcreteFragmentHash = function getConcreteFragmentHash() {
    ...
    !(hash != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'RelayQueryFragment.getConcreteFragmentHash(): ' + 'Cannot be called on a cloned fragment.') : invariant(false) : undefined;
    return hash;
  };
