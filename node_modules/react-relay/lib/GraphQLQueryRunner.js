...
function createProfiles(fetchMode) {
  var profileName = fetchMode === DliteFetchModeConstants.FETCH_MODE_REFETCH ? 'forceFetch' : 'primeCache';
  return {
...
function runQueries(queries, callback, fetchMode, profilers) {
  var readyState = {
    aborted: false,
    done: false,
    error: null,
